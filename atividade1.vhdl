...
begin
	...
	-- muxes...
	-- Exercicio 2 aqui ...
	U6: entity work.mux52x1 port map (rt, rd, RegDst, wa);
	U7: entity work.mux2x1 port map (d2, sinalExtendido, ALUSrc, input2ALU);
	U8: entity work.mux2x1 port map (RamDataOut, ALUresult, MemToReg, wd);
...
testa: process
	...
	begin
		...
		-- instrucao <= "001000 01000 00000 0000000000000001"; addi
		instrucao <= "00100001000000000000000000000001"; --- addi
		wait for 200 ps;
                instrucao <= "00100001001000000000000000000010"; --- addi
		wait for 200 ps;
                instrucao <= "00100001010000000000000000000011"; --- addi
		wait for 200 ps;
		instrucao <= "00100001011000000000000000000001"; -- addi
		wait for 200 ps;

		-- exercicio 3 aqui

		-- instrucao <= "000000 01001 01010 0000100000010000"; add
		instrucao <= "00000001001010100000000000000001";
		wait for 200 ps;
		-- instrucao <= "000000 01000 01011 0101000000010010"; sub
		instrucao <= "00100001000010000000000000000101";
		wait for 200 ps;
